// Prevent browser from restoring scroll on refresh/reopen; always start at top
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Search function - empty search shows all questions
    function performSearch() {
        ...
        faqItems.forEach(item => {
            ...
            if (questionText) {
                ...
                const matches = searchTerm === '' || questionContent.includes(searchTerm);
                if (matches) {
                    results.push({
                        id: item.id,
